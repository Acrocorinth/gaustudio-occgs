...
if __name__ == "__main__":
    colmap_dir = "/mnt/ssd4t/occgs/waymo_test/031/loftr/sparse/0/"
    image_basenames, image_heights, image_widths, c2ws, ixts = load_colmap_camera(colmap_dir)
    print(image_basenames, image_heights, image_widths, c2ws, ixts)
